import HautevilleHouse.CalabiYauTheoryComplexAnalyticCanonicalLaneLean.Formalization
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "Calabi-Yau theorem certificate internalized through Hodge theory, mirror symmetry, and Kähler geometry",
